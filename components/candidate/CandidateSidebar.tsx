...
import { CandidateMenuItem } from '../../types';
...
const Icons: Record<string, React.ReactNode> = {
  ...
  [CandidateMenuItem.JobBoard]: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>,
...
const CandidateSidebar: React.FC<CandidateSidebarProps> = ({ activeItem, onItemClick, onHomeClick, isOpen }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4 px-6 pt-6 pb-2 md:block">
        <button 
            onClick={onHomeClick}
            className="flex items-center w-full px-3 py-2.5 mb-1 text-sm font-bold text-blue-700 hover:bg-blue-50 rounded-lg group transition-colors"
        >
